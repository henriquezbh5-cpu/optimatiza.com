...
(function () {
  ...
  var AG_DICT = {
    es: {
      ...
      'ag-hero-sub': 'Cada unidad es un patr&oacute;n real de automatizaci&oacute;n que fabricamos e instalamos. No los lea: presione play y mire el flujo completo correr, paso a paso.',
      'ag-hero-cta1': 'Bajar a la sala de control &darr;',
      'ag-hero-cta2': 'Hable con un ingeniero &rarr;',
      ...
      'ag-como-1': '<strong>Elija una unidad.</strong> Cada tarjeta es un agente con un trabajo concreto.',
      'ag-como-2': '<strong>Corra la simulaci&oacute;n.</strong> El robot ejecuta el flujo real: disparadores, herramientas, decisiones.',
      'ag-como-3': '<strong>Lea el registro.</strong> La consola imprime lo que pasa de verdad, con marcas de tiempo.',
      'ag-como-4': '<strong>P&iacute;dalo para su operaci&oacute;n.</strong> Un mensaje y lo aterrizamos a sus sistemas.',
      /* floor */
      'ag-floor-index': 'SALA DE CONTROL &mdash; &Iacute;NDICE DE FLOTA',
      'ag-floor-title': 'El piso de operaciones.',
      'ag-floor-sub': 'Veinte unidades agrupadas seg&uacute;n lo que le quitan de encima. Abra cualquier unidad para ver su corrida completa.',
      'ag-floor-proof': 'Cada patr&oacute;n corresponde a un proceso que dise&ntilde;amos e implementamos sobre los sistemas del cliente. Vea un caso real &rarr;',
      ...
      'ag-cat-rrhh': 'RRHH',
      'ag-cat-legal': 'Legal',
      'ag-rail-foot': '&Iacute;NDICE DEL CAT&Aacute;LOGO &middot; DESPL&Aacute;CESE O SALTE',
      /* groups */
      'ag-group-ventas': 'C1 &mdash; VENTAS &middot; 2 UNIDADES',
      'ag-blurb-ventas': 'Responde antes de que su competencia abra Excel.',
      ...
      'ag-blurb-datos': 'Informes que se escriben solos antes de que los pida.',
      ...
      'ag-tar-s': '<strong>Unidad simple.</strong> Un flujo, una integraci&oacute;n, reglas fijas. ~1&ndash;2 semanas.',
      'ag-tar-m': '<strong>Unidad est&aacute;ndar.</strong> Multi-paso, razonamiento IA, 2&ndash;3 integraciones, ciclo de aprobaci&oacute;n. ~2&ndash;4 semanas.',
      'ag-tar-l': '<strong>C&eacute;lula compuesta.</strong> Varios agentes orquestados con memoria compartida y tableros. ~4&ndash;8 semanas.',
      ...
      'ag-tar-ref': 'PAGOS POR HITOS &mdash; EL N&Uacute;MERO REAL SALE DE UN DIAGN&Oacute;STICO DE 30 MINUTOS.',
      'ag-tar-cta': 'Solicitar una evaluación de alcance &rarr;',
      /* contact */
      'ag-contact-index': '50 &mdash; CONTACTO DIRECTO',
      'ag-contact-title': '&iquest;Cu&aacute;l de estos procesos le est&aacute; comiendo horas a su equipo?',
      'ag-contact-wa': 'Hablemos por WhatsApp',
      'ag-contact-reply': 'RESPUESTA &lt; 24H &middot; GMT-6',
      'ag-form-name': 'Nombre',
      'ag-form-email': 'Correo',
      'ag-form-msg': '&iquest;Qu&eacute; quiere automatizar?',
      'ag-form-send': 'ENVIAR',
      'ag-form-ok': 'Enviado. Respondemos en menos de 24 horas.',
      'ag-form-privacy': 'Sus datos se procesan v&iacute;a Formspree solo para responderle. No se venden ni se usan para marketing.',
      /* footer */
      ...
      'ag-x-stepper': 'USE &#9197; PARA AVANZAR PASO A PASO &middot; ESC CIERRA',
      'ag-x-steps': 'PASOS',
      'ag-x-actor-llm': 'LLM',
      'ag-x-step': 'Paso',
      'ag-x-of': 'de',
      ...
      'ag-x-form-fail-wa': 'Env&iacute;elo por WhatsApp &rarr;',
      ...
      'ag-tar-o': '<strong>Operaci&oacute;n continua.</strong> Monitoreo, ajustes y mejora mensual de sus unidades. Alcance y precio se definen en el diagn&oacute;stico.',
      ...
      "process-subtitle": "Cinco pasos claros para llevar su operación de manual a automática.",
      ...
      "step-5-short": "Producción, documentación y capacitación. Suyo.",
      ...
      "diff-2-desc": "Especialistas certificados en agentes de IA y automatización, sobre la plataforma que su empresa ya paga.",
      "diff-3-title": "Entregar y desaparecer",
      "diff-3-desc": "Documentamos, capacitamos a su equipo y damos 30 días de soporte. El sistema sigue corriendo sin nosotros.",
      ...
      "quienes-legend": "HABLA DIRECTO CON EL INGENIERO FUNDADOR — SIN CAPA COMERCIAL",
      "quienes-plate": "Optimatiza fue fundada en 2026 en San Salvador por Humberto Henríquez: ingeniero en sistemas, tres certificaciones Microsoft Power Platform, dos maestrías (Ciencia de Datos y Business Intelligence) y más de ocho años construyendo automatización para empresas de LATAM. Los sistemas de la sección Evidencia — RPA, portales, tableros, asistentes con IA — los diseñó y entregó él, y hoy son los patrones que esta fábrica instala. Aquí no hay capa comercial: cada plano lo firma el ingeniero responsable, la misma persona que atiende su diagnóstico.",
      ...
      "quienes-product-label": "Demo medida",
      "quienes-product-value": "Capturista Digital — captura de facturas por WhatsApp, ~4 segundos por factura, medido en video.",
      "quienes-product-badge": "Demo en video →",
      "quienes-profile-link": "Perfil completo del fundador →",
      "trust-title": "Cómo trabajamos con usted",
      "trust-1": "Alcance cerrado antes de empezar",
      "trust-2": "Pagos por hitos",
      "trust-3": "El código y las cuentas son suyos",
      "trust-4": "Documentación y capacitación incluidas",
      "trust-5": "Respuesta &lt;24h",
      "projects-title": "Patrones de automatización que implementamos.",
      ...
      "case-cta": "¿Tiene un proceso así? → Solicitar propuesta",
      ...
      "services-title": "¿Su proceso no está en el catálogo? Lo dibujamos a medida.",
      ...
      "svc-process-automation-desc": "Reemplazamos flujos manuales y repetitivos por automatizaciones que se ejecutan solas entre sus herramientas y bandejas de correo. Construidas con Power Automate y n8n, con aprobaciones, manejo de errores y registros claros para que nada se quede sin atender.",
      ...
      "svc-process-automation-floor": "Unidad estándar · 2–6 semanas",
      "svc-integrations-apis-badge": "Alta demanda",
      "svc-integrations-apis-title": "Integraciones y APIs",
      "svc-integrations-apis-desc": "Conectamos su ERP, CRM, herramientas SaaS y bases de datos para que los datos fluyan automáticamente en lugar de copiarse a mano. Construimos la capa de integración con n8n, webhooks y conectores a medida, con mapeo y validación en cada paso.",
      ...
      "svc-integrations-apis-result": "Sus sistemas se comunican entre sí, eliminando la doble captura y los datos desactualizados.",
      "svc-integrations-apis-floor": "Unidad estándar · 2–6 semanas",
      "svc-dashboards-bi-badge": "Más solicitado",
      "svc-dashboards-bi-title": "Tableros Interactivos y BI",
      "svc-dashboards-bi-desc": "Tableros en Power BI que convierten datos dispersos en KPIs, tendencias y alertas claras para decisiones diarias. Construidos sobre un modelo estrella correcto, con actualización programada y alertas cuando los números cruzan sus umbrales.",
      ...
      "svc-dashboards-bi-floor": "Unidad estándar o célula compuesta · 2–8 semanas",
      ...
      "svc-stack-line": "FABRICAMOS SOBRE MICROSOFT POWER PLATFORM · N8N · CLAUDE/GEMINI · NEXT.JS · SQL — USTED ELIGE EL TERRENO."
    },
    en: {
      /* nav */
      ...
      'ag-tar-s': '<strong>Simple unit.</strong> One workflow, one integration, fixed rules. ~1&ndash;2 weeks.',
      'ag-tar-m': '<strong>Standard unit.</strong> Multi-step, AI reasoning, 2&ndash;3 integrations, approval loop. ~2&ndash;4 weeks.',
      'ag-tar-l': '<strong>Composite cell.</strong> Several agents orchestrated with shared memory and dashboards. ~4&ndash;8 weeks.',
      'ag-tar-inc': 'Every unit ships with: design, build, testing, documented handover and 30 days of post-launch support.',
      'ag-tar-ref': 'MILESTONE-BASED PAYMENTS &mdash; THE REAL NUMBER COMES OUT OF A 30-MINUTE DIAGNOSTIC.',
      'ag-tar-cta': 'Request a scope assessment &rarr;',
      /* contact */
      ...
      "quienes-plate": "Optimatiza was founded in 2026 in San Salvador by Humberto Henríquez: a systems engineer with three Microsoft Power Platform certifications, two master's degrees (Data Science and Business Intelligence) and eight-plus years building automation for companies across LATAM. The systems in the Evidence section — RPA, portals, dashboards, AI assistants — were designed and delivered by him, and they are the patterns this factory installs today. There is no sales layer here: every drawing is signed by the engineer of record — the same person who takes your diagnostic call.",
      ...
      "quienes-product-label": "Measured demo",
      "quienes-product-value": "Capturista Digital — invoice capture over WhatsApp, ~4 seconds per invoice, measured on video.",
      "quienes-product-badge": "Video demo →",
      "quienes-profile-link": "Full founder profile →",
      "trust-title": "How we work with you",
      "trust-1": "Scope closed before we start",
      ...
      "case-cta": "Have a process like this? → Request a proposal",
      ...
      "svc-process-automation-floor": "Standard unit · 2–6 weeks",
      "svc-integrations-apis-badge": "High demand",
      "svc-integrations-apis-title": "System Integrations &amp; APIs",
      "svc-integrations-apis-desc": "Connect your ERP, CRM, SaaS tools and databases so data flows automatically instead of being copied by hand. We build the integration layer with n8n, webhooks and custom connectors, with mapping and validation at every step.",
      ...
      "svc-integrations-apis-floor": "Standard unit · 2–6 weeks",
      ...
      "svc-dashboards-bi-floor": "Standard unit or composite cell · 2–8 weeks",

...
const translations = (function () {
  ...
  var I18N = {
    ...
    "btc-teaser-k": ["<i class=\"ph ph-currency-btc\"></i> ANEXO · ASESORÍA BITCOIN", "<i class=\"ph ph-currency-btc\"></i> ANNEX · BITCOIN ADVISORY"],
    "btc-teaser-h": ["¿También operas Bitcoin? Tenemos una línea aparte para eso.", "Also trade Bitcoin? We have a separate line for that."],
    "btc-teaser-p": ["Asesoría de operador a operador desde 2017: aprende a operar tú, te acompaño o gestiono bajo mandato — <strong>sin custodia</strong> y <strong>sin promesas de rendimiento</strong>. Es otra decisión y otro riesgo, por eso vive en su propia página.", "Trader-to-trader advisory since 2017: learn to trade yourself, get monthly guidance, or managed under mandate — <strong>non-custodial</strong> and <strong>no promises of returns</strong>. It's a different decision and a different risk, so it lives on its own page."],
    "btc-teaser-cta": ["<i class=\"ph ph-currency-btc\"></i> Ver asesoría Bitcoin →", "<i class=\"ph ph-currency-btc\"></i> See Bitcoin advisory →"],
